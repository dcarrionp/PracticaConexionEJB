...
a persistence unit "server2PersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "server2/pom.xml":
...
artifact ("server2.war") is already built. You can build
